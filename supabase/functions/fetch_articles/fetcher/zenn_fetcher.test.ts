...
Deno.test("ParserのparseURLが呼び出されること", async () => {
  const mockItems: ZennItem[] = [
    { title: "Item 1", creator: "Author 1", content: "Content1", link: "https://example.com/item1" },
    { title: "Item 2", creator: "Author 2", content: "Content2", link: "https://example.com/item2" },
  ];
...
// 異常系
Deno.test("ZennFetcher.fetch()が失敗すると、MediaFetchErrorが発生すること", async () => {
  const parserStub = stub(Parser.prototype, "parseURL", () => {
